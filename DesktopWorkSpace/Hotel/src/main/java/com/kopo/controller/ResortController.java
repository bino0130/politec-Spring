...
//					}
	...
	@PostMapping("/admin/ReservationUpdatePage_1") // HttpServletRequest request, HttpSession session �궘�젣
	...
	@PostMapping("/admin/ReservationUpdatePage_2") // HttpServletRequest request, HttpSession session �궘�젣
