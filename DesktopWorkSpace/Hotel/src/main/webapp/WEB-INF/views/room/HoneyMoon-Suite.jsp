...
<section class="about_history_area section_gap">
	<div class="container">
        <div class="row">
           	<div class="col-md-6">
                <img src="${pageContext.request.contextPath}/resources/img/room3.jpg" style="width: 450px; height: 500px; margin-top:25px;">
            </div>
            <div class="col-md-6 d_flex align-items-center">
            	<div class="about_content ">
                    ...
                    <ul class="unordered-list">
                      	<li><b style="color:black;">객실 이름 : HoneyMoon-Suite Room</b></li>
                       	<li>크기 : 149㎡(구45평)</li>
                       	<li>구조 : 침실3(침대방1+온돌방2) +거실+화장실2(독립테라스)</li>
                       	<li>구비시설 : TV, 냉장고, 에어컨, 전자렌지, 쇼파, 식탁, 주방집기, 헤어드라이기, 샴푸, 린스, 타올</li>
                       	<li>인원 : 기준 10명 / 최대 15명</li>
