...
function validateForm() { // 데이터 전달하는 form 체크
	 var title = document.forms["insertReviewForm"]["review_title"].value; // insertReviewForm 태그 안에 있는 review_title의 value를 가져옴
	 var reviewer = document.forms["insertReviewForm"]["review_person"].value; // insertReviewForm 태그 안에 있는 review_person의 value를 가져옴
	 var content = document.forms["insertReviewForm"]["review_content"].value; // insertReviewForm 태그 안에 있는 review_content의 value를 가져옴
		...
		<div class="section-top-border">
			<div class="progress-table-wrap">
				<div class="progress-table">
					<form:form modelAttribute="insertReviewForm" method="POST" onsubmit="return validateForm()">
						<div class="table-head" style="text-align:center;">
							<div class="serial">제목</div>
							<form:input path="review_title" type="text" value="" placeholder="Title" onfocus="this.placeholder=''" 
						...
						<div class="table-head" style="text-align:center;">
							...
							<form:input path="review_person" type="text" value="" placeholder="Reviewer" onfocus="this.placeholder=''" 
