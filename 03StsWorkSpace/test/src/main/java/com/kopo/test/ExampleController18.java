...
access - pattern에 설정된 경로로 접근할 수 있게 권한 부여
...
IS-AUTHENTICATED-ANONYMOUS - 익명 사용자
IS-AUTHENTICATED-REMEMBERED - 기억된 사용자
