...
%>
<form:form modelAttribute="NewReservation" name="NewReservation" method="POST" onsubmit="return validateForm()">
<table class="secondTable">
<tr>
	<td class="tdTwo">성명</td>
	<td class="tdEight">
		<form:input path="customer_name" type="text" value="" maxlength="16" placeholder="성함을 입력해주세요"/>
	</td>
</tr>
<tr>
	<td class="tdTwo">예약일자</td>
	<td class="tdEight">
		<form:input id="Date" path="resv_date" type="text" value="" placeholder="날짜를 선택해주세요" readonly="true"/>
		<script>
			$(function() {
				$("#Date").datepicker({
					minDate: new Date(), // 현재날짜로부터 100년이전까지 년을 표시한다.
					maxDate: '+365d',
					dateFormat: "yy-mm-dd",
...
<tr>
	...
	<td class="tdEight">
		<form:input path="addr" type="text" value="" placeholder="주소를 입력해주세요" maxlength="33" style="width : 320px;"/>
	</td>
</tr>
<tr>
	<td class="tdTwo">전화번호</td>
	<td class="tdEight">
		<form:input path="telnum" type="text" value="" placeholder="전화번호를 입력해주세요" maxlength="13"
...
<tr>
	...
	<td class="tdEight">
		<form:input path="in_name" type="text" value="" maxlength="16" placeholder="입금자명을 입력해주세요"/>
	</td>
</tr>
<tr>
	<td class="tdTwo">남기실 말</td><td class="tdEight">
		<form:input path="memo" value="" maxlength="50" style="width : 320px;" placeholder="남기실 말을 입력해주세요"/>
...
<tr>
	<td colspan='2' style="border : 1px solid black; height : 30px;">
		...
		<span>
			<c:if test="${duplicateFind eq 1}">
				<script>
				var num = <c:set var="duplicateFind" value=""/>;
					alert('현재 선택하신 방은 이미 예약된 방입니다 죄송합니다. 다른 날짜를 택하여 주십시오');
					console.log(num);
        		 	location.href="${pageContext.request.contextPath}/d_02_1";
				</script>
			</c:if>
		</span>
	</td>
