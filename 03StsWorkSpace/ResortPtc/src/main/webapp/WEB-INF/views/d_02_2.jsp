					...
					<tr>
						...
						<td class="tdEight">
							<form:input path="addr" type="text" value="${resort.addr}" maxlength="33" 
								placeholder="주소를 입력해주세요" style="width:320px;"/>
						</td>
					</tr>
					<tr>
	...
	<c:otherwise>
			<form:form modelAttribute="NewReservation" method="POST" onsubmit="return validateForm()">
				<table class="secondTable">
					...
					<tr>
						<td class="tdTwo">예약방sd</td>
						<td class="tdEight">
							<div class="dropdown">
								<form:select path="room" id="room">
									<form:option value="1"  >VIP 룸</form:option>
									<form:option value="2"  >비즈니스 룸</form:option>
									<form:option value="3"  >스탠다드 룸</form:option>
								</form:select>
								<span>${room}</span>
							</div>
						</td>
