...
<tr>
	<td class="tdTwo">예약일자</td><td class="tdEight"><form:input path="resv_date" type="text" value=""/></td>
</tr>
<!-- <tr>
	<td class="tdTwo">기존 예약일자</td><td class="tdEight"><form:input path="resv_date" type="text" value=""/></td>
</tr> -->
<tr>
