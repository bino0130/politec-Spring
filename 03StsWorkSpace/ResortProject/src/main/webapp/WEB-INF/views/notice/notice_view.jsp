							...
							<div style="text-align:right; width:600px;">
								<div class="mt-10" style="text-align: right;">
									<sec:authorize access="hasRole('ROLE_ADMIN')">
										<button type="button" class="genric-btn danger radius" data-toggle="modal" data-target="#deleteNotice">삭제</button>
										<!-- modal -->
	     									...
	     									<div class="modal-dialog">
    											<div class="modal-content">
      												...
      												<div class="modal-footer">
														...
														onclick="location.href='${pageContext.request.contextPath}/admin/notice_delete?notice_id=${oneNotice.notice_id}'"
										...
										<button type="button" class="genric-btn info radius"
											onclick="location.href='${pageContext.request.contextPath}/admin/notice_update?notice_id=${oneNotice.notice_id}'">수정</button>
									</sec:authorize>
								</div>
							</div>
						</div>
