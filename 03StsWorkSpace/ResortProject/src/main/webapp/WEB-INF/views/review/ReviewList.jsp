		...
		<div class="section-top-border">
			...
			<div class="progress-table-wrap">
				<div class="progress-table">
					...
					<c:forEach items="${reviewList}" var="noticeList">
						<div class="table-head" style="text-align:center;">
							<div class="serial">${reviewList.notice_id}</div>
							<div class="percentage" style="margin-left:50px; padding-right:0px; text-align:left;">
								<a style="color:black;" href="<c:url value="/notice_view?notice_id=${reviewList.review_id}"/>">
									<c:out value="[공지] ${reviewList.review_title}"/>
								</a>
							</div>
							<div class="percentage" style="padding-right:0px;">${reviewList.review_date}</div>
